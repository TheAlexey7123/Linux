...
#Download programs
sudo apt install -y 7zip bspwm sxhkd rofi picom feh ranger imagemagick wireshark flameshot net-tools cmatrix neofetch iputils-ping curl git sudo nano john
